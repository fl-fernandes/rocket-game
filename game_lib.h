...
namespace game_t
{
	...
	{	
		...
		inline vector_t get_speedx ()
		{
			return this->speed.x;
		}
		
		inline vector_t set_speedx (vector_t x)
		{
			this->speed.x = x;
		}
		
		inline vector_t get_speedy ()
		{
			return this->speed.y;
		}
		
		inline vector_t set_speedy (vector_t y)
		{
			this->speed.y = y;
		}
	};
